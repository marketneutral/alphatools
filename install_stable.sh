...
conda create -n env_alphatools_stable -y -c conda-forge python=$PYTHON_VERSION numpy=1.11.3 pandas=0.18.1 scipy=0.17.1 libgfortran=3.0 mkl-service pymc3=3.1 lightgbm=2.2.0 scikit-optimize=0.5.2 scikit-learn lapack catboost pip
