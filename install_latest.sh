conda create -n env_alphatools_latest -y python=3.5 numpy=1.14.1 pandas=0.22.0 scipy=1.0.0 libgfortran=3.0 pip
...
python -m ipykernel install --user --name env_alphatools_latest --display-name "Python 3.5 (env_alphatools_latest)"
